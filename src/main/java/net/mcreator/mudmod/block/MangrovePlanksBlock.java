...
public class MangrovePlanksBlock extends MudModModElements.ModElement {
	@ObjectHolder("mud_mod:mangrove_planks")
	public static final Block block = null;
	public MangrovePlanksBlock(MudModModElements instance) {
		super(instance, 10);
	}
