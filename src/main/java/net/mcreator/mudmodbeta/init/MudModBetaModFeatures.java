...
import net.mcreator.mudmodbeta.world.features.plants.MangrovePropaguleFeature;
...
public class MudModBetaModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(MangrovePropaguleFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION,
				MangrovePropaguleFeature.GENERATE_BIOMES, MangrovePropaguleFeature.CONFIGURED_FEATURE));
	}
