...
public class MangrovePressurePlateBlock extends PressurePlateBlock {
	public MangrovePressurePlateBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(MudModBetaModBlocks.MANGROVE_PRESSURE_PLATE, renderType -> renderType == RenderType.cutout());
	}
}
