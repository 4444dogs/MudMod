...
public class MangroveFenceBlock extends FenceBlock {
	public MangroveFenceBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(MudModBetaModBlocks.MANGROVE_FENCE, renderType -> renderType == RenderType.cutout());
	}
}
