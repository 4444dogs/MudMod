...
public class MangroveDoorBlock extends DoorBlock {
	public MangroveDoorBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(MudModBetaModBlocks.MANGROVE_DOOR, renderType -> renderType == RenderType.cutout());
	}
}
